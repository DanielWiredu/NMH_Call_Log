<%@ Page Title="" Language="C#" MasterPageFile="~/CRHome.Master" AutoEventWireup="true" CodeBehind="EditClientVisitation.aspx.cs" Inherits="NMH_Call_Log.CR.Main.EditClientVisitation" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="box box-default">
            <div class="box-header with-border">
              <h3 class="box-title">Edit Client Visitation</h3>
            </div><!-- /.box-header -->
            <div class="box-body">
