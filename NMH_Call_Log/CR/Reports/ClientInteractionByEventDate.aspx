<%@ Page Title="" Language="C#" MasterPageFile="~/CRHome.Master" AutoEventWireup="true" CodeBehind="ClientInteractionByEventDate.aspx.cs" Inherits="NMH_Call_Log.CR.Reports.ClientInteractionByEventDate" %>
            ...
            <ContentTemplate>
                 <div class="modal-content">
                        <div class="modal-body">
                            ...
                            <div>
                                <telerik:RadGrid ID="eventGrid" runat="server" AllowSorting="True" DataSourceID="eventSource" GroupPanelPosition="Top">
                            <ClientSettings>
                                <Selecting AllowRowSelect="True" />
                                <Scrolling AllowScroll="true" ScrollHeight="400px" UseStaticHeaders="true" />
                            </ClientSettings>
                            <GroupingSettings CaseSensitive="false" />
                                     <ExportSettings IgnorePaging="true" ExportOnlyData="true" OpenInNewWindow="true" FileName="Client_Interaction" HideStructureColumns="true">
                                    </ExportSettings>
                            <MasterTableView AutoGenerateColumns="False" DataKeyNames="Id" DataSourceID="eventSource" AllowAutomaticDeletes="false" PageSize="100">
                                ...
                                <asp:SqlDataSource ID="eventSource" runat="server" ConnectionString="<%$ ConnectionStrings:ConnectionString %>" SelectCommand="SELECT Id, EventDate, Venue, Participants, Issues, Recommendations, CreatedBy, CreatedDate FROM tblClientInteraction WHERE (CAST(EventDate as date) BETWEEN @StartDate AND @EndDate)">
                                    <SelectParameters>
