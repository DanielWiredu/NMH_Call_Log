<%@ Page Title="" Language="C#" MasterPageFile="~/CRHome.Master" AutoEventWireup="true" CodeBehind="EditComplaint.aspx.cs" Inherits="NMH_Call_Log.CR.Complaints.EditComplaint" %>
            ...
            <FooterTemplate>
                ...
                items
                        ...
                        <div class="modal-footer">
                            ...
                            <asp:Button runat="server" ID="btnEscalate" CssClass="btn btn-info" Text="Referral" OnClientClick="openEscalateModal()" CausesValidation="false" />
                            ...
                            <asp:Button runat="server" ID="btnSave" CssClass="btn btn-success" Text="Save Changes" OnClick="btnSave_Click" />
                        </div>
                    </ContentTemplate>
                </asp:UpdatePanel>
