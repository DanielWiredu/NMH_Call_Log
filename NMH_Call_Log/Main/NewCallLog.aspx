<%@ Page Title="" Language="C#" MasterPageFile="~/Home.Master" AutoEventWireup="true" CodeBehind="NewCallLog.aspx.cs" Inherits="NMH_Call_Log.Main.NewCallLog" %>
                            ...
                            <div class="row">
                                <div class="col-md-3">
                                    ...
                                    <asp:RadioButtonList runat="server" ID="rdCallerType" AutoPostBack="true" RepeatDirection="Horizontal" OnSelectedIndexChanged="rdCallerType_SelectedIndexChanged">
                                        <asp:ListItem Text="Non NMH Member" Value="0" Selected="True"></asp:ListItem>
            ...
            <FooterTemplate>
                ...
                items
                        ...
                        <div class="modal-footer">
                            ...
                            <asp:Button runat="server" ID="btnEscalate" CssClass="btn btn-info" Text="Escalate" Enabled="false" OnClientClick="openEscalateModal()" CausesValidation="false" />
